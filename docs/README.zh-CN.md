...
从 [GitHub Releases](https://github.com/meetrize/markmemo/releases) 下载对应平台构建。
...
仓库仍在快速迭代。报告解析或渲染问题时，请使用 [issue 模板](https://github.com/meetrize/markmemo/issues/new/choose) 以便复现。
