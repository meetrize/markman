...
pub struct ThemeColors {
    ...
    /// Knowledge graph document node fill colour.
    pub graph_node_document: Hsla,
    /// Knowledge graph tag node fill colour.
    pub graph_node_tag: Hsla,
    /// Knowledge graph edge stroke colour.
    pub graph_edge: Hsla,
    /// Knowledge graph panel background colour.
    pub graph_background: Hsla,
}
...
struct ThemeColorsDe {
    ...
    graph_node_document: Option<Hsla>,
    graph_node_tag: Option<Hsla>,
    graph_edge: Option<Hsla>,
    graph_background: Option<Hsla>,
}
...
impl<'de> Deserialize<'de> for ThemeDimensions {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(Self {
            ...
            table_append_button_extent: raw.table_append_button_extent.unwrap_or(22.0),
            table_append_button_inset: raw.table_append_button_inset.unwrap_or(6.0),
            table_append_activation_band: raw.table_append_activation_band.unwrap_or(20.0),
    ...
    pub fn default_theme() -> Self {
        Self {
            ...
            dimensions: ThemeDimensions {
                ...
                code_block_padding_y: 10.0,
                code_block_padding_x: 14.0,
                code_bg_pad_x: 3.0,
                code_bg_pad_y: 1.0,
                code_bg_radius: 4.0,
                ...
                table_append_button_extent: 22.0,
                table_append_button_inset: 6.0,
                table_append_activation_band: 20.0,
                image_radius: 12.0,
