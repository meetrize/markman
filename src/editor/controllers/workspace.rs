...
pub(in crate::editor) struct WorkspaceController {
    ...
    pub(in crate::editor) name_is_selecting: bool,
    pub(in crate::editor) name_last_layout: Option<ShapedLine>,
    pub(in crate::editor) name_last_bounds: Option<Bounds<Pixels>>,
...
impl WorkspaceController {
    pub(in crate::editor) fn new(cx: &mut Context<Editor>) -> Self {
        Self {
            ...
            name_is_selecting: false,
            name_last_layout: None,
            name_last_bounds: None,
