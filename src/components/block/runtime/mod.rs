...
pub struct Block {
    ...
    pub(crate) search_highlight_active_range: Option<Range<usize>>,
    ...
    pub(crate) wiki_link_picker_single_click_generation: u64,
...
impl Block {
    pub fn with_record(cx: &mut Context<Self>, record: BlockRecord) -> Self {
        ...
        let mut block = Self {
            ...
            search_highlight_active_range: None,
            marked_range: None,
            last_layout: None,
            last_bounds: None,
            ...
            wiki_link_picker_single_click_generation: 0,
